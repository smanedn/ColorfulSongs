...
<body>
<div class="container-md bg-dark bg-opacity-50 rounded-2 p-5 shadow-lg p-3 mt-5">
    ...
    <form method="POST" action="<?php echo URL; ?>login/logIn">
        ...
        <button type="submit" class="btn btn-outline-dark" name="login" value="Login">Login</button>
